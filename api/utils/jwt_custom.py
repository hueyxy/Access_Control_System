...
class CustomBackend(ModelBackend):
    ...
    def authenticate(self, request, username=None, password=None, session_id=None, sig=None, token=None, scene=None,
                     ip=None, **kwargs):  # 重写这个函数
        ...
        if session_id:
            ...
            # 客户端IP。必填参数，后端填写。
            afs_request.set_RemoteIp("118.178.89.223")
