...
class AccessControlSerializer(serializers.ModelSerializer):
    ...
    status = serializers.ChoiceField(help_text="状态",
    ...
    class Meta:
        model = AccessControl
        fields = (
            "id", "photo", "person__username", "person__first_name", "person__last_name", "person__face__photo",
            "status",
            "accuracy", "temperature", "add_time", "note",)
...
class AccessControlAbnormalApplicationSerializer(serializers.ModelSerializer):
    ...
    result = serializers.ChoiceField(help_text="状态",
                                     choices=(("pending", "待处理"), ("pass", "通过"), ("fail", "未通过")),
                                     default="pending")
