...
class User(AbstractUser):
    ...
    lived_dormitory = models.ForeignKey(Dormitory, on_delete=models.SET_NULL, verbose_name="居住宿舍", null=True,
                                        related_name='lived_users')
...
class UserInfo(models.Model):
    ...
    gender = models.CharField(max_length=7, choices=(("male", "男"), ("female", "女"), ("unknown", "未知")),
                              default="unknown",
                              verbose_name="性别")
...
class UserFace(models.Model):
    ...
    features_mask = models.TextField(verbose_name="特征数据(口罩)", null=True)
    user = models.OneToOneField(User, verbose_name="用户", on_delete=models.CASCADE, related_name="face",null=True)
