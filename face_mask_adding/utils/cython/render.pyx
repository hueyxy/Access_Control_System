...
@cython.wraparound(False)
@cython.nonecheck(False)
def render_cy(numpy.ndarray[double, ndim=2, mode='c'] vertices, numpy.ndarray[double, ndim=2, mode='c'] new_colors,
              numpy.ndarray[long, ndim=2, mode='c'] triangles, int h, int w):
...
@cython.wraparound(False)
@cython.nonecheck(False)
cdef numpy.ndarray[double, ndim=3, mode='c'] render_texture(numpy.ndarray[double, ndim=2, mode='c'] vertices,
                                                            numpy.ndarray[double, ndim=2, mode='c'] colors,
                                                            numpy.ndarray[long, ndim=2, mode='c'] triangles, int h,
                                                            int w, int c = 3):
    ...
    cdef numpy.ndarray[double, ndim=2, mode='c'] tri_tex = numpy.empty((colors_size, triangles_size_1),
                                                                       dtype=numpy.double)

    for triangles_size_1_ptr in prange(triangles_size_1, nogil=True):
        tri_depth[triangles_size_1_ptr] = (vertices[2, triangles[0, triangles_size_1_ptr]] + vertices[
            2, triangles[1, triangles_size_1_ptr]] + vertices[2, triangles[2, triangles_size_1_ptr]]) / 3.
        for colors_size_ptr in range(colors_size):
            tri_tex[colors_size_ptr, triangles_size_1_ptr] = (colors[
                                                                  colors_size_ptr, triangles[0, triangles_size_1_ptr]] +
                                                              colors[
                                                                  colors_size_ptr, triangles[1, triangles_size_1_ptr]] +
                                                              colors[colors_size_ptr, triangles[
                                                                  2, triangles_size_1_ptr]]) / 3.
    ...
    cdef numpy.ndarray[double, ndim=2, mode='c'] vertices_idx_by_tri = numpy.empty((2, triangles_size_0),
                                                                                   dtype=numpy.double)
